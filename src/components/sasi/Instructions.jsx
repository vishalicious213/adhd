...
const Instructions = () => {
    ...
    return (
        <>
            ...
            <p className="text italics">This scale should not be used for diagnostic purposes. Instead, results should be considered as part of a structured interview, and used in conjunction with diagnostic testing when evaluating women for possible AD/HD.</p>
            <h3>Directions:</h3>
